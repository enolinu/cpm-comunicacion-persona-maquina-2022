...
public abstract class FileUtil {
	...
	public static void saveToFile(String nombreFicheroSalida, List<Articulo> listaPedido, String llevar) {
		try {
			BufferedWriter fichero = new BufferedWriter(new FileWriter(nombreFicheroSalida + ".dat"));
			String linea = listaPedido.toString();
			fichero.write(linea);
			fichero.write(llevar);
			fichero.close();
		}
